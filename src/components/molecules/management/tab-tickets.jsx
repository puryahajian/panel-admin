        ...
        <div className='mt-4'>
            ...
            <TabManagement step={step} index={0}>
                <div className='flex justify-between items-center'>
                    <Text>تمامِ تیکت‌هایی که برای واحد امور مشتریان دلیوری ارسال کرده‌اید، در این صفحه لیست شده‌اند:</Text>

                    <ButtonGeneral onClick={() => setStep(1)}>ارسال تیکت جدید</ButtonGeneral>
                </div>
