                ...
                <div className='w-full'>
                    <div className={`grid grid-cols-3 gap-4 ${classMain}`}>
                        ...
                        <div className='text-right'>
                            ...
                            <Input onChange={(e) => setPriceProduct(e.target.value)} className={`w-full text-left`} placeholder={`۳۰۰۰`}/>
                        </div> 
                        <div>
                    ...
                    <div className={`grid grid-cols-3 gap-4 ${classStatus}`}>
                        ...
                        <div className='text-right'>
                            ...
                            <Input onChange={(e) => setCapacityProduct(e.target.value)} className={`w-full text-left`} placeholder={`۳۰۰۰`}/>
                        </div>
